...
|-----|-------|--------------|
| [`egg-n8n.json`](egg-n8n.json) | `n8n:latest` | `5678` |

## 🐳 Image

```text
ghcr.io/red-shadows-rs/pterodactyl-containers/n8n:latest
```
...
**Features:** workflow automation · 400+ integrations · visual builder · configurable port
...
|----------|---------|----------|
| `N8N_PORT` | `5678` | Yes |
| `N8N_PROTOCOL` | `http` | Yes |
| `N8N_HOST` | `localhost` | Yes |
| `N8N_ENCRYPTION_KEY` | Empty | Yes |
